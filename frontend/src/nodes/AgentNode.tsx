    ...
    <>
      ...
      >
        ...
        <div className="p-3 flex items-center gap-4 text-xs text-slate-500">
          <div
            className={twMerge(
              ...
              hasPrompt ? 'text-slate-700' : 'text-slate-300'
            )}
          >
            <FileText size={14} />
          ...
          <div
            className={twMerge(
              'flex items-center gap-1.5',
              toolCount > 0 ? 'text-slate-700' : 'text-slate-300'
            )}
          >
            <Wrench size={14} />
          ...
          {data.require_approval && (
            <div
              className="flex items-center gap-1.5 text-orange-600 bg-orange-50 px-1.5 py-0.5 rounded border border-orange-100"
        ...
        <div className="absolute -left-3 top-1/2 -translate-y-1/2 flex items-center">
          ...
          />
          <span className="text-[10px] ml-2 text-slate-400 bg-white px-1 opacity-0 group-hover:opacity-100 transition-opacity">
            Input
          </span>
        </div>

        <div className="absolute -right-3 top-1/2 -translate-y-1/2 flex items-center">
          <span className="text-[10px] mr-2 text-slate-400 bg-white px-1 opacity-0 group-hover:opacity-100 transition-opacity">
            Response
          </span>
          <Handle
            type="source"
