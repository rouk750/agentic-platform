    ...
    <>
      <div
        className={twMerge(
          ...
          isActive
            ? 'border-green-500 ring-2 ring-green-500/20 shadow-xl scale-105'
            : 'border-orange-500'
        )}
      >
        {/* Input Handle */}
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">
                Iterates over {String(data.input_list_variable || 'items')}
              </div>
            </div>
          </div>
        ...
        <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex flex-col items-center">
          <span className="text-[10px] text-gray-500 bg-white px-1 border-gray-100 border rounded mb-1 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
            Next Item
          </span>
        </div>
        <Handle
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center pr-2">
          <div className="text-[10px] text-gray-500 mr-2 bg-white px-1 border-gray-100 border rounded absolute right-2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
            Complete
          </div>
        </div>
        <Handle
