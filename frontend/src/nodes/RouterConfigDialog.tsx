              ...
              <div className="space-y-3">
                {fields.map((field, index) => {
                  ...
                  return (
                    <div
                      key={field.id}
                      className="flex items-start gap-2 p-3 bg-slate-50 border border-slate-200 rounded-lg group"
                    >
                      <div className="flex-1 space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex flex-col">
                            <label className="text-[10px] text-slate-400 font-semibold mb-0.5">
                              Source
                            </label>
                            <select
