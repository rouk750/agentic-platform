            ...
            {['ollama', 'lmstudio'].includes(selectedProvider) ? (
                  ...
                  {scanning ? (
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        type="button"
                        onClick={scanModels}
                        className="text-xs bg-white px-2 rounded border border-slate-300 text-slate-700 hover:bg-slate-50"
                      >
                        Rescan
                      </button>
                    </div>
              ...
              <>
                ...
                <div>
                  ...
                  />
                  {errors.api_key && (
                    <span className="text-xs text-red-500">API Key is required</span>
                  )}
                </div>
              </>
            )}
