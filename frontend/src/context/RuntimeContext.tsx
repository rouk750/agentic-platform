...
export function RuntimeProvider({ children }: RuntimeProviderProps) {
    ...
    }, [setStatus, appendToken, addActiveNode, removeActiveNode, addLog, addMessage, clearSession, setCurrentTool, updateIteratorProgress, addToolExecution, addSnapshot, setRunId, setPaused, addTokenUsage, setGraphDefinition]);
    ...
    return (
        <RuntimeContext.Provider value={{ connect, stop, resume }}>
            {children}
