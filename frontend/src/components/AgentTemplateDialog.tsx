            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-500">
                  Maximum number of messages this agent can send in a single run. Set to 0 for no
                  limit.
                </p>
              </div>
              ...
              <div className="space-y-3 pt-4 border-t border-slate-100">
                ...
                {isFlexible ? (
                  <div className="p-3 bg-purple-50 border border-purple-100 rounded-lg text-xs text-purple-700">
                    <strong>Orchestrator Mode Active:</strong> Use your System Prompt to define the
                    different JSON structures the agent can return.
                  </div>
                ) : (
                  <div className="space-y-2">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-500">
                      Best for reasoning, explanation, and complex tasks.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-500">
                      Best for simple extraction, classification. Faster.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-2">
                    {outputFields.map((field, index) => (
                      <div key={field.id} className="flex gap-2 items-start">
                        <div className="grid gap-1 flex-1">
                          <input
                            {...smartNodeForm.register(`outputs.${index}.name`)}
                            placeholder="Field name"
                            className="w-full text-xs p-1.5 rounded border border-slate-300 font-mono focus:border-green-500 outline-none"
                          />
                          <input
                            {...smartNodeForm.register(`outputs.${index}.desc`)}
                            placeholder="Description"
                            className="w-full text-xs p-1.5 rounded border border-slate-300 focus:border-green-500 outline-none"
                          />
                        </div>
                        <button
                          type="button"
